...
public class WXPayH5PayController {
	 ...
	 * @return
	 */
	@RequestMapping("/gotoH5Page")
	public String gotoH5Page() {
		return "AgPay/gotoH5Page";
	}
	 ...
	 * @return
	 */
	@RequestMapping("/h5PageSuccess")
	public String h5PageSuccess() {
		return "AgPay/h5PageSuccess";
	}
	...
	public Object h5pay() throws Exception {
		...
		reqData.put("notify_url", "http://3hqz93.natappfree.cc/wxpay/h5pay/notify");
		// 自定义参数, 可以为终端设备号(门店号或收银设备ID)，PC网页或公众号内支付可以传"WEB"
		reqData.put("device_info", "");
		// 附加数据，在查询API和支付通知中原样返回，可作为自定义参数使用。
		reqData.put("attach", "");
		reqData.put("scene_info",
				"{\"h5_info\": {\"type\":\"Wap\",\"wap_url\": \"http://3hqz93.natappfree.cc\",\"wap_name\": \"腾讯充值\"}}");
