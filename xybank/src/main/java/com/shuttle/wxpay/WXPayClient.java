...
public class WXPayClient extends WXPay {
	...
	public Map<String, String> microPayWithPOS(Map<String, String> reqData) throws Exception {
		...
		if (WXPayConstants.SUCCESS.equals(returnCode)) {
			...
			if (ERR_CODE_USERPAYING.equals(errCode) || "SYSTEMERROR".equals(errCode) || "BANKERROR".equals(errCode)) {
				...
				String tradeState = orderQueryMap.get("trade_state");
				if (TRADE_STATE_NOTPAY.equals(tradeState) || ERR_CODE_USERPAYING.equals(tradeState)
						|| ERR_CODE_AUTHCODEEXPIRE.equals(tradeState)) {
					...
					if (WXPayConstants.SUCCESS.equals(returnCodeForReverse)
	 ...
	 *
	 * <a
	 * href="https://pay.weixin.qq.com/wiki/doc/api/micropay.php?chapter=9_16&index=11>退款结果通知文档</a>
	 * 
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * 获取沙箱环境验签秘钥API <a href=
	 * "https://pay.weixin.qq.com/wiki/doc/api/micropay.php?chapter=23_1">获取验签秘钥API文档</a>
	 * 
	 * @return
	 * @throws Exception
	 */
